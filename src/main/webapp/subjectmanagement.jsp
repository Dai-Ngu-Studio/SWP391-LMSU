                                                                            ...
                                                                            <div class="modal-body">
                                                                                <fieldset disabled>
                                                                                    <div class="form-group row">
                                                                                        <label class="col-sm-1 col-form-label">Subject Name</label>
                                                                                        <div class="col-sm-10">
                                                                                            <input type="text"
                                                                                                   class="form-control"
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label class="col-sm-1 col-form-label">Semester No</label>
                                                                                        <div class="col-sm-10">
                                                                                            <input type="text"
                                                                                                   class="form-control"
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    <label class="col-sm-3 col-form-label">Semester No</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text"
                                                                                               class="form-control"
                                                                                               name="txtUpdateSemester"
