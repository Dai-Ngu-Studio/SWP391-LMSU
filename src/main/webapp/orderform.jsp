...
<c:if test="${role eq '1' or role eq '2'or role eq '3' or role eq 'null'}">
                                    ...
                                    <div class="card-text">
                                        ...
                                        <form action="ReviewOrderServlet" method="POST" class="my-0">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input class="text-black-50 directInput" type="date"
                                                           id="txtPickupDate"
                                                           name="txtPickupDate"
                                    ...
                                    <div class="card-text">
                                        ...
                                        <form action="ReviewOrderServlet" method="POST" class="my-0">
                                            <div class="form-group my-10">
                                                ...
                                                <input type="text" class="form-control deliverInput"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small id="errorAddressTwo"
                                                       class="form-text text-muted deliverError">
                                                    Residence address is optional, must be 0-50 characters long, can
                                                    contain
