    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-2">
            <div class="list-group" id="list-tab" role="tablist">
                <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home" style="border-radius: 0">
                    Receive directly at the library
                </a>
                <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab" aria-controls="profile" style="border-radius: 0">
                    Order a delivery
                </a>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                            ...
                            <div class="card-text">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="receiptDate" name="receiptDate" style="border-radius: 0.3rem" />
                                </div>
                                <div class="form-group">
                                    <label for="receiptDate">Time of receipt</label>
                                    <select id="receiptDate" class="form-control">
                            ...
                            <div class="card-text">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inputReceiverName" placeholder="Sinh Vi En" />
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPhoneNumber">Phone Number</label>
                                        <input type="text" class="form-control" id="inputPhoneNumber" placeholder="09xxxxxxxxxx" />
                                    </div>
                                    <div class="form-group">
                                        <label for="inputAddress">Address</label>
                                        <input type="text" class="form-control" id="inputAddress" placeholder="1234 D1 Street" />
                                    </div>
                                    <div class="form-group">
