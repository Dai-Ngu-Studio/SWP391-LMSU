                                ...
                                <div>
                                    ...
                                    <p>
                                        ...
                                        <input type="text" placeholder="Enter year" id="year"
                                               name="year" value="" class="yearField"> semester at FPT University
                                        Library.
                                        ...
                                        <b>
                                            ...
                                            to
                                                <%--<input type="text" placeholder="Enter day to" id="defaultDayTo" required
                                                       name="defaultDayTo" value="">--%> <input type="date"
                                                                                                id="defaultDateTo"
                                                                                                name="defaultDateTo"
                                                                                                value=""
                                                                                                required> at room no
                                    ...
                                    <p>
                                        Textbook for subjects: <input type="text" placeholder="Enter subject"
                                                                      id="subject"
                                        ...
                                        <b class="text-danger">from <%--<input type="text" placeholder="Enter day" id="day"
                                            ...
                                            to <input type="date" id="dateTo" name="dateTo" value="" required> at room
                                            no
                                            LB101</b> .
                                    </p>
                                    <h3><b>Time:</b></h3>
                                    ...
                                    <div class="d-flex flex-row justify-content-center">
                                        <button class="btn btn-secondary m-3" type="button" data-toggle="modal"
                                                id="ViewDraft" data-target="#ViewDraftModal" title="View Draft">View
                                            draft
                                        </button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <p class="text-danger">
                                        <b>
                                            Start: <span class="draft" id="defaultDayFromDraft"></span> <span
                                                class="draft"
